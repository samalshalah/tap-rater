      ...
      z.object({
        ...
        setup: z
          .object({
            ...
            proofReceiptId: z.string().uuid().optional(),
            hostedReservationId: z.string().uuid().optional(),
            rendererVersion: z.string().max(40).optional(),
            baseTemplateContentHash: z.string().regex(/^[a-f0-9]{64}$/).optional(),
            logoContentHash: z.string().regex(/^[a-f0-9]{64}$/).optional(),
            fontSizePercent: z.number().int().min(75).max(160).optional(),
            logoSizePercent: z.number().int().min(75).max(160).optional(),
