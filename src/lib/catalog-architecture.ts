...
export const lockedPlatforms: PlatformDestination[] = [
  ...
  platform("avvo", "Avvo", "review"),
  platform("taskrabbit", "Taskrabbit", "review"),
  platform("martindale", "Martindale", "review"),
  platform("justia", "Justia", "review"),
  platform("findlaw", "FindLaw", "review"),
  platform("lawyers", "Lawyers.com", "review"),
  platform("zillow", "Zillow", "review"),
  platform("realtor", "Realtor.com", "review"),
  platform("homes", "Homes.com", "review"),
  platform("apartments", "Apartments.com", "review"),
  platform("trulia", "Trulia", "review"),
  platform("dealerrater", "DealerRater", "review"),
  platform("autotrader", "Autotrader", "review"),
  platform("carfax", "CARFAX", "review"),
  platform("edmunds", "Edmunds", "review"),
  platform("cars", "Cars.com", "review"),
  platform("cargurus", "CarGurus", "review"),
  platform("repairpal", "RepairPal", "review"),
  platform("surecritic", "SureCritic", "review"),
  platform("homeadvisor", "HomeAdvisor", "review"),
  platform("thumbtack", "Thumbtack", "review"),
  platform("houzz", "Houzz", "review"),
  platform("porch", "Porch", "review"),
  ...
  platform("whatsapp", "WhatsApp", "social"),
  platform("telegram", "Telegram", "social"),
  platform("angi", "Angi", "review"),
  platform("airbnb", "Airbnb", "review"),
  platform("agoda", "Agoda", "review"),
  platform("vrbo", "Vrbo", "review"),
  platform("hotels", "Hotels.com", "review"),
  platform("healthgrades", "Healthgrades", "review"),
  platform("vitals", "Vitals", "review"),
  platform("ratemds", "RateMDs", "review"),
  platform("caredash", "CareDash", "review"),
  platform("opencare", "Opencare", "review"),
  platform("styleseat", "StyleSeat", "review"),
