...
const phaseOneAndCoreProducts: MigratedProduct[] = [
  ...
  phaseOneProduct({
    slug: "cars-com-review-stand",
    title: "Cars.com Review Stand",
    sku: "TR-CARSCOM-STAND",
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["auto-dealer-repair"],
    platformSlug: "cars-com",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Cars.com dealership or repair shop review link with one tap or scan.",
    description:
      "Cars.com Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Cars.com dealership or repair shop review link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on Cars.com",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater Cars.com Review Stand (photo coming soon)" },
    seoTitle: "Cars.com Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Cars.com dealership or repair shop review link with one tap or scan.",
    searchKeywords: ["cars.com review stand", "cars.com nfc stand", "cars-com review nfc"]
  }),
  phaseOneProduct({
    ...
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["auto-dealer-repair"],
    platformSlug: "dealerrater",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your DealerRater dealership review link with one tap or scan.",
    description:
      "DealerRater Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your DealerRater dealership review link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on DealerRater",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater DealerRater Review Stand (photo coming soon)" },
    seoTitle: "DealerRater Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your DealerRater dealership review link with one tap or scan.",
    searchKeywords: ["dealerrater review stand", "dealerrater nfc stand", "dealerrater review nfc"]
  }),
  phaseOneProduct({
    ...
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["healthcare-dental"],
    platformSlug: "healthgrades",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Healthgrades provider review link with one tap or scan.",
    description:
      "Healthgrades Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Healthgrades provider review link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on Healthgrades",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater Healthgrades Review Stand (photo coming soon)" },
    seoTitle: "Healthgrades Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Healthgrades provider review link with one tap or scan.",
    searchKeywords: ["healthgrades review stand", "healthgrades nfc stand", "healthgrades review nfc"]
  }),
  phaseOneProduct({
    ...
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["home-services"],
    platformSlug: "angi",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Angi home services review link with one tap or scan.",
    description:
      "Angi Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Angi home services review link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on Angi",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater Angi Review Stand (photo coming soon)" },
    seoTitle: "Angi Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Angi home services review link with one tap or scan.",
    searchKeywords: ["angi review stand", "angi nfc stand", "angi review nfc"]
  }),
  phaseOneProduct({
    ...
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["home-services", "auto-dealer-repair", "retail-grocery"],
    platformSlug: "bbb",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Better Business Bureau (BBB) review and accreditation link with one tap or scan.",
    description:
      "BBB Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Better Business Bureau (BBB) review and accreditation link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on BBB",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater BBB Review Stand (photo coming soon)" },
    seoTitle: "BBB Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Better Business Bureau (BBB) review and accreditation link with one tap or scan.",
    searchKeywords: ["bbb review stand", "bbb nfc stand", "bbb review nfc"]
  }),
  phaseOneProduct({
    slug: "trustpilot-review-stand",
    title: "Trustpilot Review Stand",
    sku: "TR-TRUSTPILOT-STAND",
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["retail-grocery", "real-estate", "home-services"],
    platformSlug: "trustpilot",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Trustpilot business review link with one tap or scan.",
    description:
      "Trustpilot Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Trustpilot business review link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on Trustpilot",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater Trustpilot Review Stand (photo coming soon)" },
    seoTitle: "Trustpilot Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Trustpilot business review link with one tap or scan.",
    searchKeywords: ["trustpilot review stand", "trustpilot nfc stand", "trustpilot review nfc"]
  }),
  phaseOneProduct({
    ...
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["real-estate"],
    platformSlug: "zillow",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Zillow agent review link with one tap or scan.",
    description:
      "Zillow Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Zillow agent review link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on Zillow",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater Zillow Review Stand (photo coming soon)" },
    seoTitle: "Zillow Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Zillow agent review link with one tap or scan.",
    searchKeywords: ["zillow review stand", "zillow nfc stand", "zillow review nfc"]
  }),
  phaseOneProduct({
    ...
    categorySlug: "reviews",
    designLogic: "standard_platform_locked",
    useCaseSlugs: ["restaurants-cafes", "retail-grocery", "home-services"],
    platformSlug: "nextdoor",
    basePriceCents: standPriceCents,
    shortDescription: "Countertop NFC stand that opens your Nextdoor neighborhood recommendation link with one tap or scan.",
    description:
      "Nextdoor Review Stand is a tabletop NFC display for counters, desks, checkout areas, and reception spaces. It opens your Nextdoor neighborhood recommendation link through free basic activation, connects to one destination URL, and is tap or scan ready.",
    supportedDestinations: ["custom"],
    displayText: "Review us on Nextdoor",
    image: { src: "/uploads/products/no-photo-available.png", alt: "Tap Rater Nextdoor Review Stand (photo coming soon)" },
    seoTitle: "Nextdoor Review Stand | NFC Review Stand",
    seoDescription: "Countertop NFC stand that opens your Nextdoor neighborhood recommendation link with one tap or scan.",
    searchKeywords: ["nextdoor review stand", "nextdoor nfc stand", "nextdoor review nfc"]
  }),
  {
