...
const sections = [
  ["Product use", "Tap Rater sells printed NFC stands for local businesses. Standard Direct stands use NFC only with one destination link. Branded + QR stands include NFC, a printed QR code, customer logo, business name, and proof review before checkout."],
